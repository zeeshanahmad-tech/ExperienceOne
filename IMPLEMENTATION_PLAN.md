...
- **Domain/DNS:** is `labs@radar.ahiapp.ai` (or whatever the real address becomes) actually DNS-controlled yet, so Cloudflare Email Routing can be provisioned? Blocks Monday's plumbing step.
